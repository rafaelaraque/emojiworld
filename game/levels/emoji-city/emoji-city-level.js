  <script>
    ...
    let coolFreezeActive = false;   // ðŸ˜Ž cool: todos los enemigos estÃ¡ticos 5s
    ...
    // â”€â”€ Helicopter (anti-eagle countermeasure) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    let helicopter = null;
    let lastHeliSpawn = 0;
    let heliSpawnCooldown = 0;

    // â”€â”€ Level 1 Night Boss (ðŸ›¸) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    let nightBoss = null;
    ...
    let bossPhase2 = false;          // true once boss HP â‰¤ 50%
    let cameraY = 0;                 // vertical camera offset (phase 2)
    let bossRainDrops = [];          // falling ðŸ’§ the player can freeze
    ...
    // â”€â”€ Checkpoint system â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    let avatarPowerTimer = 0;          // countdown frames (20s Ã— 60fps = 1200)
    const AVATAR_POWER_DURATION = 1200; // 20 seconds
    let reinforcedHearts = 0;          // 0â€“3 extra shield hearts
    let weapons = [];
    let ufoShots = [];
    let lastUfoShot = 0;
    let prevCoins = 0;
    ...
    // â”€â”€ Level 2 variables â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    let currentLevel = 1;
    ...
    const animalEmojis = ['ðŸ‚','ðŸ¦”','ðŸª¨'];          // terrestres estÃ¡ticos, hacen daÃ±o
    const forestEnemyEmojis = ['ðŸ‘»','ðŸ‘¾','ðŸ¤–'];      // con movimiento, hacen daÃ±o
    const flyingEnemyEmojis = ['ðŸ¦‡'];               // voladores, baja frecuencia
    const trollEnemyEmojis  = ['ðŸ§Œ'];               // baja frecuencia, estÃ¡ticos
    const obstacleEmojis    = ['ðŸª¨'];               // obstÃ¡culo genÃ©rico nivel 1
    const nextLevelBtn = document.getElementById('next-level-btn');
    const starsContainer = document.getElementById('stars');

    // â”€â”€ Level 2 Boss 2 (ðŸ—¿) new mechanic state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    const POWER_COLORS = {
      angry: { main:'#ff3300', glow:'#ff6600', particle:'ðŸ’¥' },
      ice:   { main:'#00cfff', glow:'#aaeeff', particle:'â„ï¸' },
      fire:  { main:'#ff8800', glow:'#ffcc00', particle:'ðŸ”¥' },
      cool:  { main:'#ffe000', glow:'#ffffff', particle:'â­' },
      ghost: { main:'#9966ff', glow:'#ccaaff', particle:'ðŸ’«' }
    };

    // Constants
    const gravity = 0.5;
    const enemyEmojis = ["ðŸ¤–", "ðŸ‘¾", "ðŸŒª", "ðŸ¤–", "ðŸ‘¾", "ðŸŒª"];
    const obstacleEmojisList = ["ðŸŒµ"];
    const carEmojis = ["ðŸš•", "ðŸš—", "ðŸš™", "ðŸšŒ", "ðŸ›»", "ðŸš", "ðŸšš", "ðŸ›º"]
    let powerCooldowns = {
      angry: 0, ice: 0, fire: 0, cool: 0, ghost: 0
    };
    
    // Emojis for the bonus level
    const bonusEmojis = ["ðŸŒµ", "ðŸ›¸", "ðŸ¥¶", "ðŸ¤–", "ðŸ‘¾", "ðŸŒªï¸", "ðŸšŒ", "ðŸš™", "ðŸš—", "ðŸš•"];
    
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    //  AUDIO ENGINE â€” Banda sonora procedural + efectos de sonido
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    let _ac = null;
    ...
    // â”€â”€ Frecuencias de notas â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const N = {
    ...
    // â”€â”€ Temas musicales â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    const THEMES = {
      ...
      forest: {
        // Bosque oscuro â€” misterioso, Ã©pico, mÃ¡s lento y profundo
        bpm: 80,
    ...
    function getAC() {
      if (!_ac) {
        try {
          ...
          // Master chain: masterGain â†’ destination
    ...
    // â”€â”€ Music scheduler â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Sound effects â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    function playHeartSound() {
      try {
        const ac = getAC(); if (!ac) return;
        const t = ac.currentTime;
        // Sonido cÃ¡lido y dulce â€” dos notas ascendentes con vibrato suave
        sfxOsc('sine', 523, 784, t,        0.18, 0.25);  // C5 â†’ G5
        sfxOsc('sine', 784, 1047, t+0.18,  0.15, 0.22); // G5 â†’ C6
    ...
    function playCoinSound() {
      try {
        ...
        // sube de 1200 Hz a 1600 Hz en dos pasos rÃ¡pidos
    ...
    function playJumpSound() {
      try {
        const ac = getAC(); if (!ac) return;
        const t = ac.currentTime;
        // Mario clÃ¡sico â€” onda cuadrada 8-bit subiendo
    ...
    function playLandSound() {
      try {
        ...
        // Ruido blanco filtrado paso-bajo â†’ sonido de "golpe sordo" sin componente elÃ©ctrico
        const len = Math.floor(ac.sampleRate * 0.10);
        const buf = ac.createBuffer(1, len, ac.sampleRate);
        const d   = buf.getChannelData(0);
        for (let i = 0; i < len; i++) {
          // decay rÃ¡pido: suena como impacto corto, no como zumbido
        ...
        // Filtro paso-bajo: corta todo lo agudo (sin sierra, sin elÃ©ctrico)
    ...
    // Initialize the game â€” dispatch to correct level
    function initGame() {
    ...
    // â”€â”€ Level 1 init â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    function initLevel1() {
      ...
      player = {
        ...
        emoji: "ðŸ˜Š", baseEmoji: "ðŸ˜Š", alive: true, health: 3,
      ...
      document.querySelector('#attack-btn-wrapper .base-emoji').textContent = 'ðŸŸ£';
      ...
      updateHearts();
      timerDisplay.textContent = `â±: ${gameTimer}s`;
      coinsHud.textContent = `ðŸ’°: ${coinsCollected}`;
    ...
    // â”€â”€ Level 2 init â€” Bosque Oscuro â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    function initLevel2() {
    ...
    function updateHearts() {
      ...
      for (let i = 0; i < 3; i++) {
        ...
        if (i < reinforcedHearts) {
          heart.textContent = 'ðŸ’›'; // CorazÃ³n reforzado (dorado)
    ...
    function drawEmoji(x, y, emoji, size = 40, angle = 0, glowColor = null) {
      ...
      if (glowColor) {
        ...
        ctx.shadowBlur = 20;  // static â€” was Math.sin(Date.now()) which is very expensive per-sprite
      } else {
    ...
    function drawRoad() {
      ...
      // â”€â”€ Grass verge â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Curb (kerb) strip â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Asphalt surface â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Road edge lines (white) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ctx.fillStyle = 'rgba(255,255,255,0.9)';
      ctx.fillRect(0, roadY + 7, rW, 3);
      ctx.fillRect(0, roadY + 60, rW, 3);

      // â”€â”€ Center dashed line (yellow) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Lane dividers (dashed white) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Holes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      for (let hole of holes) {
        ...
        if (hx > -60 && hx < W + 60) {
          ...
          drawEmoji(hole.x, roadY + 28, 'ðŸ•³ï¸', 32);
        }
      }

      // â”€â”€ Star, storeEmoji, flag â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (star) {
        star.rotation += 0.1;
        drawEmoji(star.x, star.y, 'ðŸŒŸ', 42, star.rotation);
      }
      if (storeEmoji) {
        drawEmoji(storeEmoji.x, storeEmoji.y, 'ðŸª', 52, 0);
      }
      // No flag in Level 1 â€” boss arena signals the end
    }
    ...
    function drawEnemies() {
      ...
      for (let i = obstacles.length - 1; i >= 0; i--) {
        ...
        if (obstacle.burning) { drawEmoji(obstacle.x, obstacle.y, 'ðŸ”¥', 40); continue; }
      ...
      for (let i = enemies.length - 1; i >= 0; i--) {
        const e = enemies[i];
        if (e.burning) { drawEmoji(e.x, e.y, 'ðŸ”¥', 40); continue; }
        if (e.frozen) {
          // Frameless ðŸ§Š emoji with ice glow
      ...
      // â”€â”€ Sun (day / evening only) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (sunEnemy && timeOfDay === 'evening' && player.x > SECTION_EVENING) {
        ...
        sunEnemy = {
          ...
          emoji: 'ðŸŒ', originalEmoji: 'ðŸŒ', type: 'sun', health: 2, stunned: false, stunTimer: 0
        };
        lastSunSpawn = player.x;
      }

      // â”€â”€ Helicopter (anti-eagle bug patrol) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (currentLevel === 1) drawHelicopter();

      // â”€â”€ Night Boss Arena â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (currentLevel === 1 && timeOfDay === 'night') drawNightBossArena();

      // â”€â”€ Frozen-enemy ice cube platforms â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      drawFrozenEnemies();
    }

    // â”€â”€ ðŸš Helicopter â€” flies past occasionally at random altitude â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Night Boss Arena walls + boss ðŸ›¸ â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // Jump physics: gravity=0.5, jump1 vy=-12 â†’ h=144px, jump2 vy=-10 â†’ h=100px
    // Total double-jump reach above ground = ~244px
    // Phase 1 platforms: 3 floating shelves at +110, +220 above road; boss at +340
    // Phase 2: boss ascends 2Ã—H, vertical canvas scroll, rain drops ðŸ’§ become ice platforms

    function drawNightBossArena() {
      const arenaW = canvas.width + 80;
      const H = canvas.height;

      // â”€â”€ Trigger arena entry â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (!nightBossArena && !bossDefeated && player.x >= LEVEL1_LENGTH - arenaW - 200) {
        nightBossArena = true;
        nightBossArenaX = LEVEL1_LENGTH - arenaW;

        // No terrain platforms â€” player climbs via frozen rain drops in phase 2
        bossArenaPlatforms = [];
      ...
      // â”€â”€ Phase 2 transition: boss ascends when HP â‰¤ 50% â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Phase 2: boss ascends, rain drops fall, camera follows player â”€
      if (bossPhase2 && nightBoss) {
        ...
        // Spawn rain drops â€” paused while frozen
      ...
      // â”€â”€ Walls (drawn in screen space) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Clamp player inside arena walls â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Phase 2 rain drops â€” world coords, ctx.translate handles screen â”€
      if (bossPhase2) {
        const now = Date.now();
        for (let i = bossRainDrops.length - 1; i >= 0; i--) {
          ...
          if (d.frozen) {
            // Permanent frozen ice platform â€” draw with frame
            ...
            ctx.textAlign = 'center'; ctx.textBaseline = 'middle';
            ctx.fillText('ðŸ§Š', sx, sy + 2);
            ctx.restore();

            // Platform collision â€” world coords
            ...
            if (screenY > -30 && screenY < H + 30) {
              ...
              ctx.textAlign = 'center'; ctx.textBaseline = 'middle';
              ctx.fillText(d.type === 'diamond' ? 'ðŸ’Ž' : 'ðŸ’§', sx, Math.round(d.y));
              ctx.restore();
            }
            ...
            if (Math.abs(d.x - player.x) < hitR && Math.abs(d.y - player.y) < hitR) {
              ...
              // ðŸ’§ pass through â€” no damage
            }

            // Ice power freezes nearby ðŸ’§ (not ðŸ’Ž)
        ...
        // Atmospheric rain streaks (screen space â€” draw after ctx.restore in gameLoop)
      }

      // â”€â”€ Victory when boss dead â€” check BEFORE early return â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Boss shoots aliens â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      if (nightBoss.shootTimer >= shootRate) {
        ...
        const dropEmoji = Math.random() > 0.5 ? 'ðŸ‘¾' : 'ðŸ‘½';
        enemies.push({
          ...
          dropHeart: Math.random() < 0.25, // 25% chance to drop â¤ï¸ on death
          onGround: false,
          frozen: false
        });
      ...
      // â”€â”€ Draw boss â€” world coords (ctx.translate in gameLoop shifts to screen) â”€
      ...
      if (bossScreenY > -100 && bossScreenY < H + 100) {
        ...
        ctx.textAlign = 'center'; ctx.textBaseline = 'middle';
        // Draw at world y â€” ctx.translate shifts it to correct screen position
        ctx.fillText('ðŸ›¸', bx, Math.round(nightBoss.worldY));
        ctx.restore();
      ...
      // â”€â”€ Boss health bar â€” always in screen space â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      const phase2Label = bossPhase2 ? ' âš¡FASE 2' : '';
      ctx.fillText(`ðŸ›¸ JEFE FINAL  ${nightBoss.health}/${nightBoss.maxHealth}${phase2Label}`, canvas.width/2, 12);
      ctx.restore();

      // â”€â”€ Boss damage collision â€” world coords â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    function hitNightBoss(dmg) {
      ...
      playDamageSound();
      createExplosionEffect(nightBoss.x, nightBoss.worldY + 20, 'ðŸ’¥');
      if (nightBoss.health <= 0) {
        createExplosionEffect(nightBoss.x, nightBoss.worldY,    'ðŸ›¸');
        createExplosionEffect(nightBoss.x+40, nightBoss.worldY+30, 'ðŸ’¥');
        createExplosionEffect(nightBoss.x-40, nightBoss.worldY+30, 'ðŸ’¥');
        createExplosionEffect(nightBoss.x, nightBoss.worldY+60,   'âœ¨');
        playExplosionSound();
        nightBoss = null;
        cameraY = 0;
      }
    ...
    // â”€â”€ Frozen enemies â€” frameless ðŸ§Š emoji platforms â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    function drawFrozenEnemies() {
      ...
      for (let i = frozenEnemies.length - 1; i >= 0; i--) {
        ...
        // Draw frameless ðŸ§Š emoji â€” larger, with subtle ice shimmer glow
        ctx.save();
        ...
        ctx.textAlign = 'center';
        ctx.textBaseline = 'middle';
        ctx.fillText(melting ? 'ðŸ’§' : 'ðŸ§Š', drawX, drawY);
        ctx.restore();
        ...
        if (melting) {
          ...
          ctx.font = '14px serif';
          ctx.textAlign = 'center';
          ctx.fillText('ðŸ’§', drawX + ((now / 60) % 14 - 7), drawY + 26 + ((now / 80) % 14));
          ctx.restore();
        }
        ...
        // Enemy contact â†’ accelerate melt
    ...
    function updateNightAliens() {
      for (let i = enemies.length - 1; i >= 0; i--) {
        ...
        // Ice power freezes alien â†’ becomes platform (frozenEnemies list)
    ...
    function handlePlayerDamage(source) {
      ...
      // â”€â”€ Reinforced hearts absorb damage first â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (reinforcedHearts > 0) {
        reinforcedHearts--;
        updateHearts();
    ...
    // Ice vapor evaporation â€” upward-drifting steam particles
    function createVaporEffect(x, y) {
      for (let i = 0; i < 10; i++) {
        ...
        particles.push({
          ...
          emoji: 'ðŸ’¨', size: 14 + Math.random() * 16,
          life, maxLife: life,
          vapor: true
        });
      }
      ...
      for (let i = 0; i < 5; i++) {
        ...
        particles.push({
          ...
          emoji: 'â„ï¸', size: 10 + Math.random() * 10,
          life, maxLife: life
        });
      }
    }
    ...
    //  LEVEL 2 â€” BOSQUE OSCURO: drawing functions
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

    function drawTrail() {
      const W = canvas.width * 1.5;

      // â”€â”€ Undergrowth strip â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Trail dirt path â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      for (let hole of holes) {
        ...
        if (drawX > -50 && drawX < W + 50) {
          ...
          ctx.fill();
          drawEmoji(hole.x, trailY + 30, 'ðŸ•³ï¸', 30);
        }
      }

      // Star pickup
      if (star) { star.rotation += 0.1; drawEmoji(star.x, star.y, 'ðŸŒŸ', 40, star.rotation); }
      if (storeEmoji) drawEmoji(storeEmoji.x, storeEmoji.y, 'â›º', 50, 0);
      if (flag) drawEmoji(flag.x, flag.y, 'ðŸ', 60);
    }
    ...
    function drawTrees() {
      for (let tree of trees) {
        ...
        ctx.restore();
        // Tree emoji
        drawEmoji(tree.x, trailY - 55, 'ðŸŒ³', 60);
        // ðŸ¦‰ perched on the tree (decorative, no collision)
        if (tree.hasOwl) {
          drawEmoji(tree.x + 22, trailY - 88, 'ðŸ¦‰', 24);
        }
      }
    }
    ...
    function drawAnimals() {
      for (let i = animals.length - 1; i >= 0; i--) {
        ...
        if (animal.frozen) {
          ...
          ctx.font = '40px "Segoe UI Emoji","Apple Color Emoji","Noto Color Emoji",sans-serif';
          ctx.textAlign = 'center'; ctx.textBaseline = 'middle';
          ctx.fillText('ðŸ§Š', drawX, animal.y); ctx.restore();
          continue;
        }
        ...
        // Movement â€” patrolling terrestrials (skip if static or troll)
        ...
        // Subtle eye glow for hostile terrestrials (not troll â€” they have their own look)
        ...
        if (powerActive && currentPower !== 'ghost' && currentPower !== 'cool') {
          ...
          if (Math.abs(animal.x - player.x) < pRange && Math.abs(animal.y - player.y) < pRange) {
            if (currentPower === 'ice') {
              ...
              createExplosionEffect(animal.x, animal.y, 'ðŸ§Š');
            } else {
              animals.splice(i, 1);
              if (animal.dropHeart) createHeartDrop(animal.x, animal.y);
    ...
    function drawEnemiesLevel2() {
      // â”€â”€ Moving enemies â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      for (let i = enemies.length - 1; i >= 0; i--) {
        const e = enemies[i];
        if (e.burning) { drawEmoji(e.x, e.y, 'ðŸ”¥', 40); continue; }
        if (e.frozen) {
          ...
          ctx.font = '40px "Segoe UI Emoji","Apple Color Emoji","Noto Color Emoji",sans-serif';
          ctx.textAlign = 'center'; ctx.textBaseline = 'middle';
          ctx.fillText('ðŸ§Š', fx, e.y); ctx.restore();
          continue;
        }
        ...
        if (e.emoji === 'ðŸ¤–') glowCol = 'rgba(0,200,255,0.7)';
        if (e.emoji === 'ðŸ‘¾') glowCol = 'rgba(140,0,220,0.8)';
        if (e.emoji === 'ðŸ‘»') glowCol = 'rgba(220,220,255,0.7)';
        ...
        if (powerActive && currentPower !== 'ghost' && currentPower !== 'cool') {
          ...
          if (Math.abs(e.x - player.x) < pRange && Math.abs(e.y - player.y) < pRange) {
            if (currentPower === 'ice') {
              ...
              createExplosionEffect(e.x, e.y, 'ðŸ§Š');
              continue;
            } else {
              enemies.splice(i, 1);
              if (e.dropHeart) createHeartDrop(e.x, e.y);
      ...
      // â”€â”€ Obstacles in level 2 â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      for (let i = obstacles.length - 1; i >= 0; i--) {
        const obs = obstacles[i];
        if (obs.burning) { drawEmoji(obs.x, obs.y, 'ðŸ”¥', 40); continue; }
      ...
      // â”€â”€ BOSS 2 spawn â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      if (boss2ArenaX > 0) {
        ...
        ctx.font = '18px serif';
        for (let yi = 30; yi < H - 20; yi += 60) ctx.fillText('ðŸ”®', lwx - 14, yi);
        ctx.restore();

        // Draw right wall (only while boss alive â€” disappears on death)
        if (boss) {
          ...
          ctx.shadowBlur = 0; ctx.fillStyle = 'rgba(200,120,255,0.35)';
          ctx.font = '18px serif';
          for (let yi = 30; yi < H - 20; yi += 60) ctx.fillText('ðŸ”®', rwx + 4, yi);
          ctx.restore();
        }
      }

      // â”€â”€ Phase 1 â†’ 2 transition at exactly 50% â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (boss2Phase === 1 && boss.health <= boss.maxHealth * 0.5 && !boss2BarrierPhase) {
        ...
        boss2AuraTimer = 300;
        screenShake = 18;
        createExplosionEffect(boss.x, boss.y, 'âš¡');
        createExplosionEffect(boss2IceBarrier.x, boss2IceBarrier.y - boss2IceBarrier.h/2, 'ðŸ§Š');
        try {
          const ac = getAC(); if (ac) {
      ...
      // â”€â”€ Boss regenerates while barrier is up â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (boss2BarrierPhase && boss2IceBarrier) {
        ...
        if (boss2RegenTimer % 180 === 0 && boss.health < boss.maxHealth * 0.5) {
          boss.health++;
          createExplosionEffect(boss.x, boss.y - 30, 'ðŸ’š');
        }
      }
      // Barrier destroyed â†’ stop regen
      if (boss2BarrierPhase && !boss2IceBarrier) {
        boss2BarrierPhase = false;
        boss2RegenTimer = 0;
      }

      // â”€â”€ Phase 2: aura rotates every ~5s â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (boss2Phase === 2) {
        boss2AuraTimer--;
        if (boss2AuraTimer <= 0) {
      ...
      // â”€â”€ Boss frozen countdown â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (boss2Frozen) {
        boss2FrozenTimer--;
        if (boss2FrozenTimer <= 0) boss2Frozen = false;
      }

      // â”€â”€ Boss movement â€” paused while barrier phase is active â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Draw ice column barrier â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (boss2IceBarrier) {
        ...
        ctx.fillText(`${bib.hp} golpes ðŸ¤œðŸ”¥`, bx, topY - 14);

        // Boss regen pulse indicator
        if (boss2BarrierPhase) {
          ctx.fillStyle = `rgba(80,255,120,${0.4 + 0.3*Math.sin(Date.now()/300)})`;
          ctx.font = '14px serif';
          ctx.fillText('ðŸ’š regenerando...', bx, topY - 30);
        }
        ctx.restore();

        // â”€â”€ Collision: block player passage â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Boss draw â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      ctx.textAlign = 'center'; ctx.textBaseline = 'middle';
      ctx.fillText(boss2Frozen ? 'ðŸ§Š' : boss.emoji, bx, boss.y);
      ctx.restore();

      // â”€â”€ Boss health bar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      ctx.fillStyle = 'white'; ctx.font = 'bold 10px sans-serif'; ctx.textAlign = 'center';
      let phaseLabel;
      if (boss2BarrierPhase)       phaseLabel = ' ðŸ§Š Â¡Rompe la columna! ðŸ¤œðŸ”¥';
      else if (boss2Phase === 1)   phaseLabel = ' â„ï¸ Congela â†’ golpea ðŸ”¥ Ã³ ðŸ˜¡';
      else if (boss2Aura==='fire') phaseLabel = ' ðŸ”´ USA ðŸ¥¶ HIELO';
      else                         phaseLabel = ' ðŸ”µ USA ðŸ”¥ FUEGO';
      ctx.fillText(`ðŸ—¿ JEFE FINAL  ${boss.health}/${boss.maxHealth}${phaseLabel}`, canvas.width / 2, 24);
      ctx.restore();

      // â”€â”€ Boss contact damage â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Boss death â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (boss.health <= 0) {
        for (let k = 0; k < 5; k++) {
          const angle = (k / 5) * Math.PI * 2;
          createExplosionEffect(boss.x + Math.cos(angle)*50, boss.y + Math.sin(angle)*40, k%2===0?'ðŸ’¥':'âœ¨');
        }
        playExplosionSound();
    ...
    // â”€â”€ Boss 2 arrival dialogue â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    function showBoss2Dialog() {
      ...
      const lines = [
        { speaker:'ðŸ›¸', name:'NAVE ENEMIGA', color:'#c040ff',
          text:'Â¡JA JA JA! Â¡He robado los poderes de todos los emojis! ðŸ˜¤ Â¡Ahora el jefe del bosque te aplastarÃ¡ con ellos!' },
        { speaker:'ðŸ˜Š', name:'TÃš', color:'#0090ff',
          text:'Â¡No puede ser... sin poderes no tengo chance...!' },
        { speaker:'ðŸ§ðŸ»', name:'ðŸ§ðŸ» ELF MÃGICO', color:'#00cc66',
          text:'Â¡ALTO! Â¡La magia Ã©lfica no puede ser robada tan fÃ¡cil! Yo fui liberado... Â¡y devuelvo todos los poderes! âœ¨ðŸ”¥ðŸ¥¶ðŸ˜¡ðŸ˜ŽðŸ«¥ðŸ˜ðŸ¤œðŸ»' },
        { speaker:'ðŸ˜Š', name:'TÃš', color:'#0090ff',
          text:'Â¡Los siento... todos activos! Â¡Sin lÃ­mite! Â¡Voy a por ti, ðŸ—¿!' },
      ];
    ...
    // â”€â”€ Weapon hit on Boss 2 (from drawWeapons) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    function tryHitBoss2(weapon) {
      // â”€â”€ Check ice barrier by position (intercepts before reaching boss) â”€
      if (boss2IceBarrier) {
        const bib = boss2IceBarrier;
        const ibw = bib.w / 2;
        ...
        if (weapon.x > bib.x - ibw - 10 && weapon.x < bib.x + ibw + 10 &&
          ...
          if (weapon.aura === 'fire') {
            bib.hp--;
            screenShake = 5;
            createExplosionEffect(bib.x, weapon.y, 'ðŸ’§');
            if (bib.hp <= 0) {
              createExplosionEffect(bib.x, bib.y - bib.h / 2, 'ðŸ’¥');
              createExplosionEffect(bib.x - 20, bib.y - bib.h * 0.7, 'ðŸŒŠ');
            ...
            createExplosionEffect(weapon.x, weapon.y, 'â„ï¸');
          }
      ...
      // Phase 1: freeze (ice fist/power) â†’ then hit (fire/angry fist/power)
      if (boss2Phase === 1) {
        ...
        if (isIce && !boss2Frozen) {
          ...
          createExplosionEffect(boss.x, boss.y, 'â„ï¸');
          playCoinSound();
          boss.hitCooldown = 20;
          return true;
        }
        if (boss2Frozen && (isFire || isAngry)) {
          ...
          boss.hitCooldown = 35;
          screenShake = 10;
          createExplosionEffect(boss.x, boss.y, 'ðŸ’¥');
          playDamageSound();
          return true;
        }
        // Wrong element
        createExplosionEffect(weapon.x, weapon.y, boss2Frozen ? 'ðŸš«' : 'ðŸ›¡ï¸');
        boss.hitCooldown = 15;
        return true;
      }
      ...
      if (boss2Phase === 2) {
        ...
        if (canHit) {
          ...
          boss.hitCooldown = 25;
          screenShake = 8;
          createExplosionEffect(boss.x, boss.y, boss2Aura === 'fire' ? 'ðŸ’§' : 'ðŸ”¥');
          playDamageSound();
          return true;
        }
        createExplosionEffect(weapon.x, weapon.y, 'ðŸ›¡ï¸');
        boss.hitCooldown = 15;
        return true;
      }
      return false;
    ...
    // â”€â”€ Final ending story â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    function showEndingDialog() {
      ...
      const dialogue = [
        { speaker:'player', left:'ðŸŽŠ', right:'ðŸ˜Š', line:'Â¡Lo logrÃ©! Â¡El Bosque Oscuro estÃ¡ a salvo! ðŸŒ³âœ¨' },
        { speaker:'friends', left:'ðŸ”¥', right:'ðŸ¥¶', line:'Â¡Gracias, hÃ©roe! Â¡Nunca lo olvidaremos! Los emojis somos libres gracias a ti ðŸ˜­ðŸ’ª' },
        { speaker:'friends', left:'ðŸ˜¡', right:'ðŸ§ðŸ»', line:'Â¡Tu valentÃ­a y los poderes del elf mÃ¡gico salvaron a todos! Â¡Eres una leyenda! ðŸ†' },
        { speaker:'player', left:'ðŸ˜Ž', right:'ðŸ˜Š', line:'Fue un honor. Mientras haya emojis en peligro... Â¡yo estarÃ© ahÃ­! ðŸ’™' },
        { speaker:'ship', left:'ðŸ›¸', right:'ðŸ˜¤', line:'No tan rÃ¡pido, terrÃ­cola... ðŸ˜ˆ Esta guerra NO ha terminado.' },
        { speaker:'ship', left:'ðŸ›¸', right:'ðŸ’€', line:'Pronto regresarÃ© con un ejÃ©rcito mÃ¡s poderoso... Â¡y robarÃ© cada uno de tus poderes para siempre! âš¡ðŸ‘¾' },
        { speaker:'player', left:'ðŸ˜¤', right:'ðŸ˜Š', line:'Â¡Cuando vuelvas... te estaremos esperando! ðŸ”¥ðŸ¥¶ðŸ˜¡ðŸ˜Ž' },
      ];
      ...
      function showStep(i) {
        ...
        name.textContent = isShip ? 'ðŸ›¸ NAVE ENEMIGA' : (isFriends ? 'âœ¨ EMOJIS AMIGOS' : 'ðŸ˜Š TÃš');
    ...
    // â”€â”€ Asteroid class (enhanced) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    class Asteroid {
      constructor() {
    ...
    function updateAsteroids() {
      ...
      for (let i = asteroids.length - 1; i >= 0; i--) {
        ...
        if (!hit && Math.abs(a.x-player.x) < 28 && Math.abs(a.y-player.y) < 28) {
          ...
          updateHearts();
          playDamageSound();
          createExplosionEffect(a.x, a.y, 'ðŸ’¥');
    ...
    function drawHeartDrops() {
      for (let i = heartDrops.length - 1; i >= 0; i--) {
        ...
        drawEmoji(heart.x, heart.y, 'â¤ï¸', 30);
      }
    }
    ...
    function drawCoins() {
      for (let i = coins.length - 1; i >= 0; i--) {
        const coin = coins[i];
        coin.rotation += 0.1;
        drawEmoji(coin.x, coin.y, 'ðŸª™', 30, coin.rotation);
    ...
    function drawWeapons() {
      for (let i = weapons.length - 1; i >= 0; i--) {
        ...
        // â”€â”€ Fist: draw with elemental aura glow â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        if (weapon.type === 'fist') {
        ...
        // â”€â”€ Level 2: weapons also hit animals (ðŸ‚ðŸ¦”ðŸ§ŒðŸª¨ terrestrials) â”€â”€
        ...
        // Night boss (ðŸ›¸) â€” cowboy/eagle weapons + ice power can hit
        ...
        // Boss 2 (ðŸ—¿) â€” fist with correct element hits boss
    ...
    function updatePlayer() {
      ...
      // â”€â”€ Avatar power countdown â€” skip entirely when elven active â”€â”€â”€â”€â”€â”€
      ...
      // In boss phase 2 there is no floor â€” player must stand on frozen rain platforms
      ...
      // Actualizar ciclo dÃ­a/tarde/noche
    ...
    function activateElvenPowers() {
      ...
      player.emoji = 'ðŸ˜';
      document.querySelector('#attack-btn-wrapper .base-emoji').textContent = 'ðŸŸ£';
      document.querySelector('#attack-btn-wrapper .overlay-emoji').textContent = 'ðŸ¤œðŸ»';
      attackBtnWrapper.classList.remove('inactive');
      attackBtnWrapper.classList.add('active-avatar');
      ...
      // Grant reinforced hearts (5 hearts from ðŸ§ðŸ» blessing)
      player.health = 5;
      reinforcedHearts = 5;
      ...
      // Visual fanfare
      screenShake = 12;
      createExplosionEffect(player.x, player.y, 'ðŸ§ðŸ»');
      createExplosionEffect(player.x - 60, player.y, 'âœ¨');
      createExplosionEffect(player.x + 60, player.y, 'âœ¨');
      createExplosionEffect(player.x, player.y - 50, 'ðŸ’š');
      createExplosionEffect(player.x + 30, player.y - 30, 'ðŸ’š');
      try {
        const ac = getAC(); if (ac) {
          const t = ac.currentTime;
    ...
    function activatePower(power) {
      ...
      if (power === 'cool') {
        ...
        coolFreezeTimer = 420; // 7s Ã— 60fps
      }
    ...
    // Desactivar avatar comprado â†’ volver a poderes base
    ...
    function generateLevel() {
      ...
      while (lastPlatformX < player.x + canvas.width + 300 && lastPlatformX < levelLength) {
        ...
        // â”€â”€ Level 2 â€” Trees (ðŸŒ³) and fern decoration (ðŸª¾) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        if (currentLevel === 2 && Math.random() < 0.5) {
          trees.push({
            x: lastPlatformX + gap + Math.random() * 220,
            y: trailY - 30,
            // 30% chance to have a decorative ðŸ¦‰ perched on it
            hasOwl: Math.random() < 0.3
          });
        }
        // Occasional ðŸª¾ fern in place of a tree (decorative, no collision)
        ...
        // â”€â”€ Level 2 â€” Animals (terrestres, estÃ¡ticos, hacen daÃ±o) â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Level 2 â€” Troll ðŸ§Œ (baja frecuencia, estÃ¡tico, grande) â”€â”€â”€â”€â”€â”€
        if (currentLevel === 2 && Math.random() < 0.10) {
          animals.push({
            x: lastPlatformX + gap + width / 2,
            y: trailY - 20,
            emoji: 'ðŸ§Œ', type: 'troll',
            dropHeart: true,
        ...
        // â”€â”€ Level 2 â€” Moving enemies (ðŸ‘» ðŸ‘¾ ðŸ¤–) on platforms â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Level 2 â€” Bat ðŸ¦‡ (volador, baja frecuencia) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // Obstacles
        if (Math.random() < 0.3) {
          const obsEmoji = currentLevel === 2 ? 'ðŸª¨' : obstacleEmojisList[Math.floor(Math.random() * obstacleEmojisList.length)];
          obstacles.push({
            x: lastPlatformX + gap + 30 + Math.random() * (width - 60),
            y: y - 20,
            emoji: obsEmoji,
    ...
    // â”€â”€ WORLD DRAWING HELPERS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    function updateBackground() {
      ...
      // â”€â”€ LEVEL 2 â€” Bosque nocturno â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (currentLevel === 2) {
        ...
        // Stars â€” draw in two passes (small/large) to minimize state changes
      ...
      // â”€â”€ LEVEL 1 (original) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      if (player.x < SECTION_EVENING) {
        // â”€â”€ DAY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ EVENING â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        const sky = ctx.createLinearGradient(0, 0, 0, H);
        ...
        // â”€â”€ NIGHT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        const sky = ctx.createLinearGradient(0, 0, 0, H);
    ...
    // â”€â”€ MONTAÃ‘AS: perfil continuo (sin segmentos, sin mÃ³dulo, sin saltos) â”€
    // La altura en cada pÃ­xel se calcula como worldX = screenX + cameraX*speed
    // El perfil es una funciÃ³n continua: suma de senos con distintas frecuencias/fases.
    // Al mover la cÃ¡mara worldX cambia suavemente â†’ sin saltos posibles.

    function mountainProfile(worldX, li) {
      // Tres armÃ³nicos superpuestos, parÃ¡metros distintos por capa
      const params = [
        // [freq1,  freq2,  freq3,  phase1, phase2, phase3]   â† capa lejana
      ...
      // Cada armÃ³nico normalizado 0-1, pesos 50%+30%+20%
      return (
    ...
    function drawMountains(tod) {
      ...
      layers.forEach(({ speed, scaleMin, scaleMax, li }) => {
        // â”€â”€ Color degradado por capa y momento del dÃ­a â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Dibujar perfil como polilÃ­nea muestreada cada 3px â”€â”€â”€â”€â”€â”€â”€
        const layerScroll = cameraX * speed; // crece suavemente, sin mÃ³dulo
        const STEP = 3;
        ...
        // â”€â”€ LÃ­nea de cresta sutil (solo capa cercana) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        if (li === 2) {
    ...
    // â”€â”€ Checkpoint banner â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    function resumeFromCheckpoint() {
      ...
      // â”€â”€ Level 2 checkpoint: just restart level 2 from the start â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Level 1 checkpoint â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      // Shared reset (keep coins from checkpoint, keep avatar)
      const savedAvatar     = purchasedAvatar;
      const savedAvatarBase = player?.baseEmoji ?? 'ðŸ˜Š';

      // Partial init â€” reset player + world but keep checkpoint progress
      resizeCanvas();
      player = {
        x: 100, y: roadY - 40, vx: 0, vy: 0, w: 40, h: 40,
        onGround: true, jumpCount: 0, maxJumps: 2, rotation: 0,
    ...
    function gameOver() {
      ...
      coinsDisplay.textContent = `ðŸ’°: ${coinsCollected}`;
      clearTimeout(damageEmojiTimeout);
      ...
      if (currentLevel === 2 && level2CheckpointSaved) {
        cpLabel.textContent = 'ðŸ“ Continuar en el Bosque Oscuro ðŸŒ³';
        cpLabel.style.display = 'block';
        cpBtn.style.display = 'block';
      } else if (currentLevel === 1 && lastCheckpoint !== null) {
        const labels = {
          evening: 'ðŸ“ Vuelves al inicio de la tarde',
          night:   'ðŸ“ Vuelves al inicio de la noche',
          boss:    'ðŸ“ Vuelves al Jefe Final ðŸ›¸',
        };
    ...
    // â”€â”€ Boss defeat dialogue cutscene â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    function showBossComic() {
      ...
      // Dialogue: left = ðŸ›¸ (ship), right = ðŸ˜Š (player)
      // speaker: 'ship' | 'player'
      const dialogue = [
        { speaker:'ship',   line:'Â¡Im-posible... Â¡Me has vencido! ðŸ˜¤' },
        { speaker:'player', line:'Â¡SÃ­! Â¡El mundo estÃ¡ a salvo! ðŸŽ‰' },
        { speaker:'ship',   line:'Â¡Ingenuo! Mis aliados ya se adentran en el Bosque Oscuro... ðŸŒ³' },
        { speaker:'player', line:'Â¡Entonces irÃ© a detenerlos! ðŸ’ª' },
        { speaker:'ship',   line:'Â¡AllÃ­ encontrarÃ¡s cosas que no esperas, terrÃ­cola! ðŸ‘¾' },
        { speaker:'player', line:'Â¡Me las arreglarÃ©! Siempre lo hago ðŸ˜Ž' },
        { speaker:'ship',   line:'Â¡Hasta la prÃ³xima... si sobrevives! ðŸš€', leaves:true },
      ];
      ...
      function showStep(i) {
        ...
        leftCh.textContent  = 'ðŸ›¸';
        rightCh.textContent = 'ðŸ˜Š';
        ...
        // Speaker label
        name.textContent  = isShip ? 'ðŸ›¸ NAVE ENEMIGA' : 'ðŸ˜Š TÃš';
    ...
    function victory() {
      ...
      // Save win state for parent to detect
      try {
        localStorage.setItem('emojiGameWon', 'true');
        localStorage.setItem('emojiGameWinTime', Date.now().toString());
      } catch(e) {}
      
      if (window.parent && window.parent !== window) window.parent.postMessage('EMOJIGAME_WIN', '*');
      playVictorySound();
      ...
      if (currentLevel === 1) {
        // Normal Level 1 win â†’ show victory screen with next level button
        victoryScreen.style.display = "flex";
        scoreVictory.textContent = `Distancia: ${Math.floor(player.x/10)}m`;
        coinsVictory.textContent = `ðŸ’°: ${coinsCollected}`;
        const victoryMsg = document.getElementById('victory-message');
        if (victoryMsg) victoryMsg.textContent = 'Â¡Has vencido al ðŸ›¸ y completado el Nivel 1! Â¡Siguiente parada: el Bosque Oscuro! ðŸŒ³';
        nextLevelBtn.style.display = 'block';
      } else {
        // Level 2 complete â†’ show credits screen
      ...
      if (coinsCollected >= cost) {
        ...
        switch(avatar) {
          case 'cowboy':
            player.baseEmoji = 'ðŸ¤ ';
            document.querySelector('#attack-btn-wrapper .base-emoji').textContent = 'ðŸŸ£';
            document.querySelector('#attack-btn-wrapper .overlay-emoji').textContent = 'ðŸªƒ';
    ...
    function initBonusGame() {
      ...
      bonusGameTimer = setInterval(() => {
        ...
        if (bonusTimeLeft <= 0) {
          clearInterval(bonusGameTimer);
          bonusGameTimer = null;
          bonusMessage.textContent = "Â¡Tiempo agotado! Volviendo al juego...";
      ...
      if (flippedCards.length === 2) {
        ...
        if (card1.emoji === card2.emoji) {
          ...
          if (matchedPairs === 8) {
            ...
            coinsCollected += 20;
            coinsHud.textContent = `ðŸ’°: ${coinsCollected}`;
            bonusMessage.textContent = "Â¡Felicidades! Ganaste 20 monedas extra";
    ...
    function gameLoop() {
      ...
      // Reset shadow state â€” leftover from previous frame causes unexpected glows
      ...
      // cameraY is negative when camera scrolled up (e.g. cameraY=-200 â†’ canvas shifts +200 down)
      if (cameraY !== 0) {
        ctx.save();
        ctx.translate(0, -cameraY);
      }
      ...
      if (cameraY !== 0) {
        ...
        // Phase 2 rain streaks â€” atmospheric effect in screen space
        if (bossPhase2) {
          ctx.save();
          ctx.globalAlpha = 0.15;
      ...
      if (coolFreezeActive) {
        ...
        ctx.textAlign = 'center';
        ctx.fillText('ðŸ˜Ž FREEZE', canvas.width / 2, barY - 4);
        ctx.restore();
      }
    ...
    function setupEventListeners() {
      ...
      // Power slots â€” free switching when elvenPowersActive
      powerSlots.forEach(slot => {
        const tryActivate = (e) => {
    ...
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    //  MELODÃA DEL PRÃ“LOGO â€” Intro Ã©pica tipo aventura animada
    ...
    function startPrologueMusic() {
      ...
      _prlRunning = true;
      _schedulePrlLoop(80); // pequeÃ±o delay inicial
    }
    ...
    // ===== PRÃ“LOGO â€” CHAT MESSENGER STYLE =====
    let currentPage = 0;
    ...
    const prologuePages = [
      {
        messages: [
          { side:'left',  type:'narrator', emoji:'ðŸŒ', secondary:['ðŸœï¸','ðŸžï¸','ðŸ™ï¸'],
            sender:'Narrador', text:'Un mundo lleno de paisajes y emociones...' },
          { side:'right', emoji:'ðŸ˜Š', secondary:['ðŸ˜‰','ðŸ˜','ðŸ˜'],
            sender:'TÃº', text:'Â¡QuÃ© lugar tan hermoso!' },
        ]
      },
      {
        messages: [
          { side:'left',  type:'villain', emoji:'ðŸ‘½', secondary:['ðŸ‘¾','ðŸ¤–'],
            sender:'SeÃ±al desconocida', text:'Fue invadido por criaturas de otro mundo. ðŸ‘¾' },
          { side:'left',  type:'villain', emoji:'ðŸ›¸', secondary:['ðŸ‘¾','ðŸ¤–','ðŸ‘»','ðŸŒªï¸'],
            sender:'Nave enemiga ðŸ›¸', text:'Â¡Naves extraterrestres y criaturas oscuras surcaron los cielos!' },
        ]
      },
      {
        messages: [
          { side:'right', emoji:'ðŸ˜±', secondary:['ðŸ˜¡','ðŸ¥¶'],
            sender:'TÃº', text:'Â¡Â¿QuÃ© estÃ¡ pasando?! Â¡Hay que detenerlos!' },
          { side:'left',  type:'narrator', emoji:'ðŸ§ðŸ»', secondary:['âœ¨','ðŸ”®'],
            sender:'Elfa MÃ¡gica', text:'Calma... TÃº tienes el poder de los emojis. Â¡Ãšsalos para salvar el mundo! ðŸŒŸ' },
        ]
      },
      {
        messages: [
          { side:'left',  type:'narrator', emoji:'ðŸ’ª', secondary:['ðŸ”¥','ðŸ¥¶','ðŸ˜¡','ðŸ˜Ž'],
            sender:'Elfa MÃ¡gica', text:'Con fuego ðŸ”¥, hielo ðŸ¥¶ y furia ðŸ˜¡ podrÃ¡s vencer a cualquier enemigo.' },
          { side:'right', emoji:'ðŸ˜Ž', secondary:['ðŸ¤ ','ðŸ”¥','ðŸ¥¶','ðŸ˜¡'],
            sender:'TÃº', text:'Â¡Entendido! DefenderÃ© este mundo con todo lo que tengo. Â¡Vamos! ðŸš€' },
        ]
      }
    ];
    ...
    // â”€â”€â”€ NG+ MODE: powers combine with weapons â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // In NG+, avatar weapons can freely combine with ðŸ”¥ðŸ¥¶ðŸ˜¡ powers
